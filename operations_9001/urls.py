...
path('trainingReg/<str:plan_number>/', views.trainingReg, name='trainingReg'),

path('trainings_pending_evaluation/', views.trainings_pending_evaluation, name='trainings_pending_evaluation'),
